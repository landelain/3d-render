...
public : 
    ...
    Voronoi_Diagram(std::vector<Vector> points, int N_disk = 10){
        this->points = points;
...
public:
    ...
    void time_step(double dt){
        ...
        for(int i = 0; i < particles.size(); i++){
            ...
            Vector all_forces = g + spring_force;
